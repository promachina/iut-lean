...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  of the explicit summandwise invariant-unit logarithm images.  It lies in the
  closed tensor lattice and is transported exactly by the vertical Kummer
  equivalence, so its direct containment in the common integral region is
  constructed.  At archimedean places Ind3 contains
