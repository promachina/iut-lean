...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  vertex, as in the next sentence of the source proof.  The exact subgroup
  ...
  general morphism formalism, cofinal compatible fixed-vertex systems,
  total-estrangement argument, maximal-compact/verticial classification, the
