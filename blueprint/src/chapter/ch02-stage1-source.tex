...
\begin{definition}[Continuous theta-value germs and Gaussian monoids]
  ...
  quotient.  The remaining precise source obligation is to extract, from a
  zero constructed Kummer germ, compatible roots lying in one such finite
  extension and thereby derive injectivity.
