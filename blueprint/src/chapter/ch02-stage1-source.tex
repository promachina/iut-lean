...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  \leanok
  A group action by automorphisms of a simple tree preserves graph distance.
  If a subgroup fixes two vertices, it therefore fixes every vertex on their
  unique geodesic, formalizing the closed-edge vertex content of
  \emph{Semi-graphs of Anabelioids}, Lemma~1.8(ii)(b).  The exact subgroup
  ...
  two cusp-conjugacy conclusions of Corollary~2.5.  The finite-action fixed
  vertex-or-edge theorem, the maximal-compact/verticial classification, the
