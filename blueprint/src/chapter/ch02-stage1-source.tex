...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  local radius-\(\pi\) tensor, in the packet unit ball.  An infinite-place
  log-link step is only a partial correspondence on these circle-unit tuples.
  ...
  surjectivity proof, or direct containment.  This construction is the
  pointwise circle-unit core; the surrounding Aut-holomorphic semi-germ
  neighborhood projective systems of Remark~1.1.1(ii) are not yet constructed.
  ...
  open, as do construction of the archimedean semi-germ systems, the adjacent
  finite and infinite unit correspondences, and the four horizontal
