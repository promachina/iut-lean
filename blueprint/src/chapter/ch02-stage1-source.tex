...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  \lean{Iut.SourceTheorem15TimesMuHorizontalCoricity}
  \lean{Iut.SourceTheorem15TimesMuHorizontalCoricity.thetaLink_full}
  \lean{Iut.SourceTheorem15TimesMuHorizontalCoricity.toTriangleSquare}
  ...
  Corollary~4.10(iv) source record therefore states the stronger claim
  separately: every times-\(\mu\) horizontal class has a mono-analytic
  ...
  carries structure-preserving maps to and from the common model, so Lean
  derives a canonical member of the full theta link.  From that member and
  two-sided Theorem~1.5 Kummer sources, Lean reconstructs the upper and vertical maps, defines the
  ...
  outputs and proving the stated fullness and Kummer source data from
  Corollaries~4.5, 4.6, 4.10 and Theorem~1.5 remain open.  The
