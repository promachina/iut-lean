...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  functor, derives $\bigcap_N(H\vee N)=H$ from profinite separation, injects
  each $H$-coset into a compatible finite-level system, and proves that the
  compatible vertex and edge stabilizers equal the Bass--Serre stabilizers.
  ...
  deck equivariance for their vertex, edge, and branch maps.  Proving that
  every compatible component system is obtained from a $G/H$ coset, enriching
  these raw levels to finite etale coverings of anabelioids, and connecting the
  abstract subgroups to constituent fundamental groups remain open.
