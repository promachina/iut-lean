...
\begin{definition}[Mono-theta environments and inverse-limit group]
  ...
  \(\ell\Delta^\Theta\).  Construction of the arithmetic tempered group and
  subgraph inclusion, derivation of the two cusp-inertia facts from the
  stable-reduction semi-graph and IUT~I, Corollary~2.5, identification of all
  three generic Definition~2.7 inputs, the full reduction morphisms, and the
  link to Corollary~2.8 remain source obligations.
\end{definition}
