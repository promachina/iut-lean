...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  equivalence.  Product by $G/H$ preserves finite limits and colimits, and the
  pullback is packaged by the factorization criterion of
  Definition~1.2.2.  The arbitrary-object component decomposition and
  exactness statement, and the converse classification of all connected
  finite-etale morphisms, remain open.
