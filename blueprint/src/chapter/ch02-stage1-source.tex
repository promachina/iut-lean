...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  discharge clauses~(a)--(b) until the finite and archimedean Frobenioid
  construction interfaces have been derived and populated, and the
  isomorphism category for
  \(F^{\vdash\times\mu}\) have been constructed.  The
