...
\begin{definition}[Source Frobenioid prime strips]
  ...
  If the stage type is countable, the countable filtered-category theorem
  constructs a monotone cofinal natural-number subsystem, hence the strict
  positive-integer presentation used by the paper.  Proving this countability
  from the local-field finiteness theorem, and reconstruction from the
  abstract \(D_v\) group, remain open.
