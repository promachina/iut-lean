...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  their unique geodesic.  These results formalize the closed-edge simple-graph
  content of \emph{Semi-graphs of Anabelioids}, Lemma~1.8(ii)(a--b).  The exact subgroup
  ...
  two cusp-conjugacy conclusions of Corollary~2.5.  The source semi-graph type
  with open edges, the maximal-compact/verticial classification, the inverse-limit
  proof of Proposition~2.4(i), and construction of cusp inertia from stable
