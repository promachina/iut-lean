...
\begin{definition}[Mono-theta environments and inverse-limit group]
  ...
  group.  Construction from tempered geometry, the \(\ell\Delta^\Theta\) and
  restricted-tempered ambient subquotients, identification of the generic
  Definition~2.7 local-Galois input with this quotient, the full reduction
