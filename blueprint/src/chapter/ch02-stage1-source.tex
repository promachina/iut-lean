...
\begin{definition}[Continuous theta-value germs and Gaussian monoids]
  ...
  correspondence then constructs the associated finite fixed extension.  The
  remaining precise source obligation is to extract, from a zero constructed
  Kummer germ, compatible adjusted roots lying in that extension and thereby
  derive injectivity.
