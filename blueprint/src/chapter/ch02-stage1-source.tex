...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  images and forward iterated-log images.  At archimedean places it contains
  ...
  These declarations are source-shaped interfaces, not a construction of
  Theorem~3.11.  Constructing the tensor packets, splitting monoids, fields,
  Frobenioids, vertical Kummer maps, and Ind3 system from this lattice and the
  IUT~II Kummer/log-link results remains open, as do the four horizontal
