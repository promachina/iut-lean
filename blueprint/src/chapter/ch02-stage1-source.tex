...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  estranged branch images forces the contained subgroup to be trivial.  The exact subgroup
  ...
  two cusp-conjugacy conclusions of Corollary~2.5.  The source branch-set and
  general morphism formalism and arbitrary finite semi-graph quotients, Remark~2.2.1's
  derivation of the two branch containments, the one-or-two compatible
  fixed-vertex systems, maximal-compact/verticial classification, the
