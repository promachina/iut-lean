...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  facts validate the exact typed coarsification, reconstruction, and
  conjugation mechanism but do not discharge clauses~(a)--(b): the component
  finite/archimedean reconstruction algorithms and the
  Theorem~1.5/Corollary~2.3 horizontal maps must still be constructed from the
  cited source theorems.  The
