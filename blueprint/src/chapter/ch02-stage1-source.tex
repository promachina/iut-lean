...
\begin{definition}[Mono-theta environments and inverse-limit group]
  ...
  \(\ell\Delta^\Theta\).  Transport of the latter into the arithmetic tempered
  group, its Corollary~2.5 subgraph restriction, identification of all three
  generic Definition~2.7 inputs, the full reduction morphisms, and the link to
