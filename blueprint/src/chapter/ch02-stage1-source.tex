...
\begin{definition}[Source Frobenioid prime strips]
  ...
  \(O_{\overline{K_v}}^\triangleright\).  Continuity of Krull restriction to
  the finite Galois group, together with its discrete topology, proves joint
  continuity of evaluation on every finite stage.  This remains true after
  restricting a stage to its integral monoid and including it into the
  ind-carrier.  The continuity-with-parameters theorem needed to pass these
  stagewise results to joint continuity on the full ind-colimit, and
  reconstruction from the abstract \(D_v\) group, remain open.
