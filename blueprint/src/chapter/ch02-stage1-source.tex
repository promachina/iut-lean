...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  supplies a compatible system of such finite-level subjoints.  The exact subgroup
  ...
  general morphism formalism and arbitrary finite semi-graph quotients, the
  group-containment and total-estrangement argument, the one-or-two compatible
