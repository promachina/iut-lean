...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  conjugate constituent subgroup.  Constructing the universal profinite
  covering from normal open subgroups and identifying its inverse-limit
  components with this coset semi-graph remain open.
