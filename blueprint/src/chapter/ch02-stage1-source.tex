...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  every square.  Following the convention of IUT~I, Section~0, an
  \(F\)-prime-strip full poly-isomorphism is represented by a componentwise
  ...
  conjugating the triangle square and cancelling those comparisons.  The
