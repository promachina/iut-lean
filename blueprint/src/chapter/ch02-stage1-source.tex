...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  a continuous profinite-group equivalence.  It remains to construct the
  noncanonical comparison between arbitrary fiber functors and identify the
  original pointed fundamental-group map with the open inclusion up to inner
  conjugacy.
