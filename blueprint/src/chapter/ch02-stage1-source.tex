...
\begin{definition}[Assembled source Theorem 3.11 column boundary]
  ...
  \lean{Iut.SourceTheorem311ColumnBoundary.kappaClauseD_commutes}
  \leanok
  ...
  data, adjacent log-link relations, splitting and labeled Kummer data,
  multiradial functor, and four horizontal squares.  From these Lean derives
  the actual procession action, independent summand action, generated
  \(\Ind{1}/\Ind{2}\) quotient, vertical packet Kummer maps, \(\Ind{3}\)
  system, vertical log-volume independence, roots-only bad-prime logarithm
  equality, and the four commutative horizontal squares.
