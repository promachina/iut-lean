...
\begin{definition}[Tempered semi-graph cusp rigidity]
  ...
  finite-etale morphism asserted by the remark.  Comparison of arbitrary
  fiber functors remains in the broader Proposition~1.1.4 work and is not used
  for this chosen-basepoint converse.
