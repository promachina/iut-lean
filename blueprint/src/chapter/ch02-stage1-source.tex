...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  connected-component theorem rather than an arbitrary input.  An
  infinite-place log-link step is only a partial correspondence on these
  semi-germ core-point tuples.
  ...
  holomorphic semi-germ automorphism are not yet formalized.  Equality to the common
  ...
  open, as do the complete Aut-holomorphic assignment and rigidity theorem,
  construction of the adjacent finite and infinite unit correspondences from
  the Gaussian log-theta lattice, and the four horizontal compatibility
  constructors.
\end{definition}
