...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  every square.  The triangle and environment prime-strip squares range over
  every \(m\); the environment family carries its natural comparisons with
  the triangle strips, and its square is derived by conjugating the triangle
  square with those comparisons.  The mono-theta square ranges over every \(m\) and bad
