...
\begin{definition}[Source-shaped Theorem 3.11 interfaces]
  ...
  corner is definitionally based on the mono-analytic transport of its actual
  site or vertically coric theater; the ordinary-\(F\) square remains only as
  precursor scaffolding.  Following the convention of IUT~I, Section~0, a
  ...
  facts validate the exact typed coarsification and conjugation mechanism but
  do not discharge clauses~(a)--(b): the endpoint families must still be
  populated from Corollary~4.10 and the Theorem~1.5/Corollary~2.3 horizontal
  maps must still be constructed.  The
