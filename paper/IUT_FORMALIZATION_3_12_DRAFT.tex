...
\item the Step (xii) shadow: local Frobenioid \(p_v^N\)-ambiguity changes
  ...
  determinant reading; conversely, Lean proves the diagnostic collapse case:
  if two shifted local readings with unequal exponents and nonzero local step
  are both placed inside the same collapsed subset, their quotient images agree
  while the underlying shifted log-volumes remain unequal;
