...
\item the Corollary 3.12 finiteness endpoint:
  ...
  hull/determinant upper-ray datum forces the finite real branch;
...
\item the opening sign reduction in the proof of Corollary 3.12:
  ...
  reduction to the case \(-|\log(\Theta)|<0\);
...
\(-|\log(\Theta)|\in\mathbb{R}\cup\{+\infty\}\), the direct
...
two-computation q-pilot record, and positive-rational unit rigidity.
