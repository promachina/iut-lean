...
Frobenioid-calibration shadows, plus the direct Step (xi-g)-to-(xi-f) endpoint
bridge giving \(C_\Theta\ge-1\) from the two-computation q-pilot record and
positive-rational unit rigidity.
