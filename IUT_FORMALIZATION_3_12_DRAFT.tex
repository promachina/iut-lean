...
\item a Gaussian-to-factored-SHE bridge:
  ...
  is nonpositive and the \(\Theta\)-source average is nonnegative;
...
\(q^{j^2}\)-exponent rather than assumed.
...
target value bounded above by that average.  The genuinely difficult branch is
still the negative \(\Theta\)-source comparison.
