...
\item the Step (xi-d) determinant-normalization shadow: rank \(>1\), determinant,
  positive tensor power, and normalized log-volume;
...
action, base-valuation product, coric-transfer, and determinant-normalization
shadows.
...
\item the genuine holomorphic hull and determinant operations of Step (xi),
  beyond the present finite determinant-normalization shadow;
