...
\item the IUT II Remark 4.7.3 zero/nonzero weighted-volume relation:
  ...
  At the Gaussian-value level, the sign subgroup with \(t=0\) preserves
  coordinate Gaussian degrees pointwise; conversely, when the environment
  degree is nonzero, any affine pointwise Gaussian preservation already forces
  \(t=0\).
