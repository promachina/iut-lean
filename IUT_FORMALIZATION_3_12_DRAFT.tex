...
The Corollary 2.2(C2) flag records the displayed three-step logarithmic
inequality chain.  The Corollary 2.2(C1) flag records the displayed prime-scale
window and its elementary consequences.  The log-different/log-conductor flag
records the bridge from tripodal field terms to curve functions.
