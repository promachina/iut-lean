...
\item a Gaussian-to-factored-SHE bridge:
  ...
  \(ZMod\) carrier and proves the same upper bound for this nonzero average;
...
their finite nonzero-label average.
...
remaining task is to connect this refined nonzero-label statement, together with
the separate core/coric bookkeeping, to the hull/log-volume route.  The present
formalization now has the nonzero average, but the final route still consumes
the older all-label square/full-label average.
