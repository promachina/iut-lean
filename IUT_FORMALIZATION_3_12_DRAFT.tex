...
is impossible.  The genuinely difficult branch must therefore refine the
label/domain statement or use additional hull/log-volume structure before the
target bound is formulated.
