  ...
  [ { name := "packet",
    ...
    { name := "sourceWithSymmetry",
      ...
      consumerDeclaration :=
        "",
      note :=
        "Symmetry-label/fiber transport data remains a source-level theorem to derive from the log-theta procession for the broad route.  The local-degree source-gap branch now has a checked lowering that constructs this packet-indexed wrapper from possible-image witness, equality-quotient, and fiber transport data." },
...
def canonicalStage1ResidualFrontier :
  ...
  [ { name := "p-adic-defect/main valuation-ball controlled Record-Ob3/Ob5 residual source",
    ...
    { name := "selected p-adic arithmetic-gap source from selected case-defined Haar-defect source",
      status := .derived,
      declarationName :=
        "IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.PrincipalPointwiseValuationBallProcessionalPadicUnitBallIUTIVArithmeticDivisorLocalizedStepXISource.SelectedTheorem110PadicNormalizedCaseDefinedProcessionalArithmeticGapSource.ofSelectedTheorem110CaseDefinedReconstructedProcessionalPadicUnitBallHaarDefectResidualSource",
      role :=
        "Derived constructor that lowers the selected p-adic arithmetic-minus-main gap to the selected case-defined Haar-defect source together with the p-adic unit-ball local arithmetic identity and normalized-place Haar-defect lower bound.  The proof rewrites the selected Theorem 1.10 local-evaluation copy to the pointwise p-adic unit-ball source, then closes `caseProcession_v + 1 <= upper_v - M_v` by ordered-real arithmetic from `upper_v = StepXI_v + defect_v + M_v`, `StepXI_v = caseProcession_v`, and `1 <= defect_v`." },
    { name := "selected p-adic arithmetic-gap source from selected case-defined Haar-defect source endpoint",
      status := .derived,
      declarationName :=
        "IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.PrincipalPointwiseValuationBallProcessionalPadicUnitBallIUTIVArithmeticDivisorLocalizedStepXISource.SelectedTheorem110PadicNormalizedCaseDefinedProcessionalArithmeticGapSource.ofSelectedTheorem110CaseDefinedReconstructedProcessionalPadicUnitBallHaarDefectResidualSource_endpoint",
      role :=
        "Endpoint theorem for the selected case-defined-to-arithmetic-gap lowering.  It records that the derived selected arithmetic-gap source satisfies the selected Theorem 1.10 endpoint, the ordinary p-adic arithmetic-gap endpoint, and the selected case-defined reconstructed Haar-defect endpoint without adding a new source obligation." },
    ...
    { name := "case-bounded projected formula-gap constituent structured-SHE endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived structured-SHE lowering for the strongest heterogeneous projected formula-gap case-bounded endpoint.  The Stage 1 source-obligation gap is constructed from the primitive concrete packet's constructed-SHE Theorem 3.11 bundle and side conditions before the projected formula-gap case residual route enters the signed dichotomy and C_Theta >= -1 endpoint." },
    { name := "case-bounded projected formula-gap constituent hull-det endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived hull/determinant-obligations lowering for the strongest heterogeneous projected formula-gap case-bounded endpoint.  The constructed-SHE source-obligation gap is still built internally, but its q-pilot positivity and source-normalization inputs are projected from IUTStage1SourceHullDetObligations rather than from a standalone side-condition package." },
    ...
    { name := "same-index case-bounded source from local arithmetic-degree source",
      status := .derived,
      declarationName :=
        "ConcretePacketProjectedPrincipalProductSameIndexWeightedDeterminantQNormalizedCaseBoundedResidualSource.ofLocalArithmeticDegreeSourceCaseBoundedResidualSource",
      role :=
        "Derived case-bounded source constructor that reuses the q-normalized local arithmetic-degree source before attaching the explicit Theorem 1.10 valuation-ball case residual source.  Since the local arithmetic-degree source already has the full adjusted-determinant and record-family-hull q-scale constructors, the strongest same-index case-bounded boundary can inherit those Remark 3.9.5 lowerings instead of exposing the three weighted determinant component equalities separately." },
    { name := "same-index record-family-hull q-scale case-bounded endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived public endpoint composing the record-family-hull q-scale constructor with the explicit Theorem 1.10 valuation-ball case residual source.  The case-bounded branch no longer exposes a q-normalized local arithmetic-degree source as a public object at this boundary; Lean constructs it from adjusted-determinant synchronization, determinant-calibrated record family-hull q-scale comparison, and the source-obligation gap before applying the case residual." },
    { name := "same-index adjusted-sum case-bounded endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived public endpoint lowering the case-bounded branch one scalar step further: Lean constructs the q-normalized local arithmetic-degree source directly from adjusted-determinant synchronization and the projected localized Step XI adjusted-sum q-normalization, then attaches the explicit Theorem 1.10 valuation-ball case residual.  The record-family-hull q-scale equality is no longer a public input on this strongest same-index case-bounded branch." },
    { name := "same-index adjusted-sum case-bounded derived-residual endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived public endpoint removing the separate local arithmetic-degree residual package from the adjusted-sum case-bounded branch.  The valuation-ball case-bounded residual source constructs its local arithmetic-degree residual payload internally via toLocalArithmeticDegreeResidualSource before the adjusted-sum same-index route proves the signed dichotomy and C_Theta >= -1 endpoint." },
    { name := "same-index adjusted-sum local-analytic case-source endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived public endpoint lowering the adjusted-sum case-bounded branch from formula-gap-indexed valuation-ball data to the local-analytic Theorem 1.10 valuation-ball source.  Lean reconstructs the formula-gap matched source, the case-bounded residual source, and its local arithmetic-degree residual package internally before proving the signed dichotomy and C_Theta >= -1 endpoint." },
    { name := "same-index adjusted-sum local-analytic procession-bound endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived public endpoint lowering the adjusted-sum local-analytic case-source branch to the projected Theorem 1.10 procession-bound residual source.  Lean expands the single case-defined procession upper bound and distinguished +1 gap into the local distinguished/nondistinguished/archimedean case source before reconstructing the formula-gap and residual packages internally." },
    { name := "same-index adjusted-sum local-analytic procession-comparison endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived public endpoint lowering the adjusted-sum procession-bound branch to the procession-comparison residual source.  The public input now separates localized Step XI equality with the procession-normalized local log-volume from the upper-semi projected procession bound; Lean reconstructs the direct procession-bound residual source internally before entering the signed C_Theta comparison." },
    { name := "same-index adjusted-sum local-analytic processional-estimate endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived public endpoint lowering the adjusted-sum procession-comparison branch to the processional-estimate residual source.  The public input carries the Step (v) distinguished exact-procession, Step (vi) nondistinguished zero, and Step (vii) archimedean metric-container identifications; Lean derives the upper-semi projected procession comparison before reconstructing the signed C_Theta route." },
    { name := "same-index adjusted-sum local-analytic case-defined processional-estimate endpoint",
      status := .derived,
      declarationName :=
    ...
    { name := "same-index adjusted-sum local arithmetic-degree residual endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived public endpoint exposing the weakest adjusted-sum residual handoff used by the same-index route.  Lean constructs the q-normalized local arithmetic-degree source from adjusted-determinant synchronization, the projected localized adjusted-sum theta identity, the Theorem 1.10 formula-gap source, the local arithmetic-degree residual package, and the source-obligation gap, then proves both the Corollary 3.12 dichotomy and C_Theta >= -1 without requiring a case-bounded or processional-estimate residual source." },
    { name := "same-index adjusted-sum p-adic arithmetic-gap residual endpoint",
      status := .derived,
      declarationName :=
    ...
    { name := "possible-image witness symmetry-label local-degree source-gap endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived lowering of the expanded q-normalized same-index local arithmetic-degree source-gap route through Theorem 3.11 possible-image data.  The endpoint constructs the packet-indexed WithSymmetryLabelTransport from the possible-image witness, equality-quotient possible-image family, symmetry-label Ind2 action-packet transports, upper-semi transports, and procession transports, then enters the existing local-degree source-obligation-gap signed dichotomy and C_Theta >= -1 route." },
    { name := "realized valuation-ball exactness local-degree source-gap endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived lowering of the same possible-image local-degree source-gap route below compact-open realized exactness.  The endpoint takes realized valuation-ball exactness, uses ConcreteValuationBallThetaClassFiberTransportThetaRegionDefinedPrincipalValuationBallRealizedExactSource.toCompactOpenRealizedExactSource to insert the compactOpenSubset = valuationBall compactOpenRadius Haar-normalization law, and then enters the possible-image symmetry-label source-gap endpoint." },
    { name := "log-shell exactness local-degree source-gap endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived lowering of the same possible-image local-degree source-gap route below realized valuation-ball exactness.  The endpoint takes the paper-facing equalities thetaRegion = realized(logShell) and logShell = valuationBall through ConcreteValuationBallThetaClassFiberTransportThetaRegionDefinedPrincipalValuationBallLogShellExactSource.toPrincipalRealizedExactSource, then uses the realized-exact and compact-open lowerings before entering the source-gap route." },
    { name := "compact-open log-Kummer map local-degree source-gap endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived lowering of the same possible-image local-degree source-gap route below log-shell exactness.  The endpoint takes compact-open local Kummer realization map data, a selected possible-region section, compatibility with valuation-factor realization, and compact-open soundness; Lean derives the correspondence, image laws, compact-open possible-region exactness, compact-open log-shell image exactness, principal log-shell image exactness, and log-shell exactness before entering the source-gap route." },
    { name := "compact-open log-Kummer graph-to-map constructor",
      status := .derived,
      declarationName :=
    ...
    { name := "compact-open log-Kummer image local-degree source-gap endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived lowering of the possible-image local-degree source-gap route below possible-region exactness.  The endpoint takes the two compact-open log-Kummer image laws, derives the equality between the selected possible region and the realized compact-open local factor by extensionality, and then enters the possible-region exact source-gap route." },
    { name := "compact-open log-Kummer correspondence local-degree source-gap endpoint",
      status := .derived,
      declarationName :=
        "",
      role :=
        "Derived lowering of the possible-image local-degree source-gap route below the image-law boundary.  The endpoint takes compact-open log-Kummer correspondence data, uses left-totality, realization compatibility, and compact-open soundness to extract the image laws, and then enters the image-law source-gap route." },
    ...
    { name := "summand-charted pointwise determinant source constructor",
      status := .derived,
      declarationName :=
        "PrincipalPointwiseValuationBallMeasureDeterminantFormulaSource.ofSummandChartedHodgeFamilyHullCalibration",
      role :=
        "Derived lower constructor for the pointwise determinant/Hodge source.  The input is the pre-ledger volume/hull equality and the summand-charted Hodge/family-hull calibration; Lean derives the determinant-normalized Hodge equality, determinant log-volume equality, and family-hull equality before constructing the pointwise determinant formula source." },
    { name := "summand-charted pointwise determinant source audit",
      status := .derived,
      declarationName :=
...
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.PrincipalPointwiseValuationBallMeasureDeterminantFormulaSource.ofSummandChartedHodgeFamilyHullCalibration
#guard_msgs (drop info) in
...
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.ConcretePacketProjectedPrincipalProductSameIndexWeightedDeterminantQNormalizedCaseBoundedResidualSource.ofLocalArithmeticDegreeSourceCaseBoundedResidualSource
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.ConcretePacketProjectedPrincipalProductSameIndexWeightedDeterminantQNormalizedCaseBoundedResidualSource.ofLocalArithmeticDegreeSourceCaseBoundedResidualSource
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.ConcretePacketProjectedPrincipalProductSameIndexWeightedDeterminantQNormalizedCaseBoundedResidualSource.dichotomy_ofLocalArithmeticDegreeSourceCaseBoundedResidualSource
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.ConcretePacketProjectedPrincipalProductSameIndexWeightedDeterminantQNormalizedCaseBoundedResidualSource.dichotomy_ofLocalArithmeticDegreeSourceCaseBoundedResidualSource
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.ConcretePacketProjectedPrincipalProductSameIndexWeightedDeterminantQNormalizedCaseBoundedResidualSource.cTheta_ge_neg_one_ofLocalArithmeticDegreeSourceCaseBoundedResidualSource
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.ConcretePacketProjectedPrincipalProductSameIndexWeightedDeterminantQNormalizedCaseBoundedResidualSource.cTheta_ge_neg_one_ofLocalArithmeticDegreeSourceCaseBoundedResidualSource
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
...
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
...
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
...
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
...
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
...
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
...
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#check IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
#print axioms IUTStage1Theorem311ToCorollary312PaperTrace.Obligations.
#guard_msgs (drop info) in
