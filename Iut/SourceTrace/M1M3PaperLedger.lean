  ...
  [ clause "FrdI.1.1(i-ii)" .frobenioidsI
    ...
    clause "III.3.9" .iutIII "IUT III, Proposition 3.9"
      ["SourceNormalizedLogVolume",
        ...
        "SourceNonarchimedeanLocalFieldIntegers.PAdicIntegralBasis.coefficientReduction",
        "SourceNonarchimedeanLocalFieldIntegers.PAdicIntegralBasis.coefficientReduction_ker",
        "SourceNonarchimedeanLocalFieldIntegers.PAdicIntegralBasis.quotientLinearEquiv",
        "SourceNonarchimedeanLocalFieldIntegers.PAdicIntegralBasis.quotient_finrank_eq",
